...
// el juego depende de la dimension de tablero
let limite;
...
let Jugador1 = new Jugador('#7db938', 'Jugador 1');
let Jugador2 = new Jugador('#606c9b', 'Jugador 2');
...
//Si selecciono una ficha la arrastra.
    ...
    if (fichaSelected != null) {
        ...
        if ((fichaSelected.posY + 35) < tablero.posY && tablero.isInRangeX(fichaSelected.posX)) {
            ...
            if (tablero.colocarFichaInTablero(fichaSelected, posInX) == true) {
                ...
                //Comprueba las condiciones de corte, si el tablero esta lleno o si alguien gano
                ...
                if (!endedGame && fullTablero != true) {
                    ...
                    //Termina el juego
                    let retorno;
                    if (endedGame) retorno = "Ganó el jugador " + winnerName;
                    else retorno = "el tablero se encuentra lleno";
                    endGame(retorno);
...
function startGame(Jugador1, Jugador2, table) {
    ...
    //Trae el tamaño deseado del tablero desde el select
...
//Muestra un cartel de que finalizo el juego
...
//Remueve las clases que permiten que sea visible el turno
...
//Agrega las clases que permiten que sea visible el turno
...
//Setea los colores de los botones segun su id
